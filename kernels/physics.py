...
from kernels.utils import (
    quat_mul, quat_rotate, quat_normalize,
    quat_from_angular_velocity, quat_conjugate, quat_rotate_inverse
)
from kernels.mpr import mpr_collide
...
def narrow_phase(num_pairs: ti.i32):
    ...
    for p in range(num_pairs):
        ...
        # =================================================================
        # Mesh collisions using MPR (Minkowski Portal Refinement)
        # Works for any convex shapes: sphere, box, mesh vs mesh
        # =================================================================

        # Sphere-Mesh
        elif type_a == data.GEOM_SPHERE and type_b == data.GEOM_MESH:
            has_contact, contact_point, normal, depth = mpr_collide(geom_a_idx, geom_b_idx)
