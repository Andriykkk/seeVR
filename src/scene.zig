...
pub const Scene = struct {
    ...
    pub fn init(vk: *Vulkan, window: ?*c.GLFWwindow, width: u32, height: u32, allocator: std.mem.Allocator) !Scene {
        var self = Scene{
            .vk = vk,
            .window = window,
            .width = width,
    ...
    fn initRaster(self: *Scene, vk: *Vulkan, allocator: std.mem.Allocator) !void {
        ...
        if (c.vkCreateRenderPass(vk.device, &c.VkRenderPassCreateInfo{
            ...
            .pSubpasses = &c.VkSubpassDescription{
                ...
                .pColorAttachments = &c.VkAttachmentReference{ .attachment = 0, .layout = c.VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL },
                .pResolveAttachments = null, .pDepthStencilAttachment = &depth_ref,
    ...
    pub fn endFrame(self: *Scene) !void {
        ...
        _ = c.vkQueueSubmit(self.vk.graphics_queue, 1, &c.VkSubmitInfo{
            ...
            .waitSemaphoreCount = 1, .pWaitSemaphores = &self.image_available[self.current_frame],
            .pWaitDstStageMask = &wait_stage,
            .commandBufferCount = 1, .pCommandBuffers = &cmd,
            .signalSemaphoreCount = 1, .pSignalSemaphores = &self.render_finished[self.current_frame],
        }, self.in_flight[self.current_frame]);

        _ = c.vkQueuePresentKHR(self.vk.graphics_queue, &c.VkPresentInfoKHR{
            .sType = c.VK_STRUCTURE_TYPE_PRESENT_INFO_KHR, .pNext = null,
            .waitSemaphoreCount = 1, .pWaitSemaphores = &self.render_finished[self.current_frame],
            .swapchainCount = 1, .pSwapchains = &self.swapchain,
            .pImageIndices = &self.current_image, .pResults = null,
        });
