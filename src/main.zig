...
pub fn main() !void {
    ...
    // Stacked boxes
    _ = try d.addBox(.{ 0, 1, 0 }, .{ 0.5, 0.5, 0.5 }, .{ 0.85, 0.15, 0.15 }, 0.5, 0.0, mat_red);
    _ = try d.addBox(.{ 0.02, 2.5, 0 }, .{ 0.5, 0.5, 0.5 }, .{ 0.95, 0.95, 0.95 }, 0.5, 0.0, mat_mirror);
    _ = try d.addBox(.{ -0.02, 4.0, 0 }, .{ 0.5, 0.5, 0.5 }, .{ 1.0, 0.76, 0.33 }, 0.5, 0.0, mat_gold);
    _ = try d.addBox(.{ 0.01, 5.5, 0 }, .{ 0.5, 0.5, 0.5 }, .{ 0.35, 0.8, 0.35 }, 0.5, 0.0, mat_rubber);
    // Side boxes
    ...
    // Spheres
    _ = try d.addSphere(.{ 1.5, 3, 0 }, 0.4, .{ 0.8, 0.85, 1.0 }, 128 * 4, 0.2, 0.37, mat_glass);
